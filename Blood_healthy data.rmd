...
#all_markers <- FindAllMarkers(pDC_combined,min.pct = 0.25, logfc.threshold = 0)
#EnhancedVolcano(all_markers,x='avg_log2FC',y='p_val',lab=rownames(all_markers),title='DE genes found in pDCs using sex and treatment as covariates')
pDC_combined <- pDC
